...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    MessageViewController *secondView = [[MessageViewController alloc] init];
    UITabBarItem *msgBar = [[UITabBarItem alloc] initWithTitle:@"信息" image:[UIImage imageNamed:@"see"] tag:2];
    secondView.tabBarItem = msgBar;
    ...
    serchView.tabBarItem = searchBar;
    ...
    NSArray *viewController = @[mainView,secondView,serchView,setView];
